...
PROMPT Tabla STRATUMS creada

-- Creando tabla clientes

CREATE TABLE APP_DATOS_IMPRESION.CLIENTS (
	ID INTEGER GENERATED BY DEFAULT ON
NULL AS IDENTITY
START WITH
1 INCREMENT BY 1,
...
PROMPT Tabla CONSUMPTIONS creada
...
PROMPT Tabla PRINTSPOOLS creada
